package com.example.implementacionApiRest.auth.JWTFilter;
...
import com.example.implementacionApiRest.auth.serviceJWT.JWTServiceImpl;
...
//			}
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		body.put("mensaje", String.format("Hola %s, perteneciente al Grupo: %s. has iniciado sesión con éxito!",authResult.getName(), authResult.getAuthorities()) );
